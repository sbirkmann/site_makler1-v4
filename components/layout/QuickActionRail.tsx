        ...
        {actions.map((action) => {
          ...
          return (
            <Link
              key={action.href}
              href={action.href}
              className="group flex w-[4.5rem] flex-col items-center gap-1.5 border-b border-white/15 bg-primary-800 px-2 py-4 text-white transition-colors last:border-b-0 hover:bg-[var(--color-accent-onwhite)]"
            >
              <Icon size={20} />
